...
class TestPacket(unittest.TestCase):
    ...
    def test_uCAM_init_packet(self):
        ...
        packet = waps_packet.WapsPacket(datetime.datetime(2023, 3, 29, 14, 11, 54, 100000),
    ...
    def test_uCAM_data_packet(self):
        ...
        packet = waps_packet.WapsPacket(datetime.datetime(2023, 3, 29, 14, 11, 54, 300000),
    ...
    def test_FLIR_init_packet(self):
        ...
        packet = waps_packet.WapsPacket(datetime.datetime(2023, 3, 29, 14, 11, 54, 500000),
    ...
    def test_FLIR_data_packet(self):
        ...
        packet = waps_packet.WapsPacket(datetime.datetime(2023, 3, 29, 14, 11, 54, 700000),
    ...
    def test_other_BIOLAB_TM_packet(self):
        ...
        packet = waps_packet.WapsPacket(datetime.datetime(2023, 3, 29, 14, 11, 54, 900000),
    ...
    def test_wrong_packet_length(self):
        ...
        packet = waps_packet.WapsPacket(datetime.datetime(2023, 3, 29, 14, 11, 54, 110000),
